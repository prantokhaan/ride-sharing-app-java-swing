...
public class CustomerViewRides extends JFrame {
    private JTextArea ridesTextArea;
    private Customer customer;

    public CustomerViewRides(Customer customer, String filename) {
    ...
    private void loadRides(String filename) {
        try {
            ...
            while (fileIn.available() > 0) {
                ...
                if (ride.getCustomer().equals(customer.getUsername())) {
                    rides.add(ride);
                }
            }
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                new CustomerViewRides(customer, "ride.ser");
            }
        });
    }
}
